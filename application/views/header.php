...
<head>
	...
	<meta property="og:image" content="http://www.superfmradio.com/top402018/media/image/top40-social.jpg" />
	
	<meta property="og:description" 
  content="Ετοιμάσαμε την λίστα με τα 40 τραγούδια, ελληνικού και ξένου ρεπερτορίου, με τις περισσότερες μεταδόσεις στον SUPER FM μέσα στο 2018*. Ζητάμε από εσάς, τους ακροατές μας, να μας βοηθήσετε να διαμορφώσουμε τη τελική κατάταξη στο SUPER TOP40 του 2018 και να αναδείξουμε το Νο1, το δημοφιλέστερο τραγούδι της φετινής χρονιάς!" />
	...
	<?php /*?><link href="css/style.css" rel="stylesheet"><?php */?>
