...
<?php /*?><button class="buttonimg"><img src="smavote.jpg" /></button><?php */?>
...
<!--<div class="closex"><button class="button1">x</button></div>-->
    ...
    <div class="page-content backgr" style="/*min-height:auto !important;min-height:4316px;*/min-height:5555px;">
        ...
        <div class="row-fluid span10 offset1 box-shadow--8dp" style="background-color: #fff;margin-bottom:30px;margin-top:20px;">
			...
			<div style="/*width:180px;*/ text-align:center; /*margin-left: 36.75213675213675%; width: 31.623931623931625%;*/"><img src="logo.jpg" style="/*max-width:290px;*/max-width:500px; text-align:center;"></div>
...
<?php */?>            </div>
			...
			</br></br><h3 style="line-height: 25px; text-align:center;width: 90% !important;">Ανάδειξε τους αγαπημένους σου καλλιτέχνες μέσα από 10 διαφορετικές κατηγορίες.<br>Δες τις υποψηφιότητες και ψήφισε πιο κάτω τους καλύτερους για το 2015-2016.</h3></br></br>
...
<h4 style="text-align:center;width: 90%;">Συμπλήρωσε πιο κάτω τα στοιχεία σου για να μπεις στην κλήρωση για εκατό προσκλήσεις για την μεγάλη συναυλία τον Super Music Awards by Lidl.</h4>
...
<?php /*?><div class="controls">
  ...
  <p style="text-align:center;">Το email και το τηλέφωνο είναι αναγκαίο για να επικοινωνήσουμε μαζί σου σε περίπτωση που κερδίσεις.</p>
            ...
            <div class="row-fluid span10 offset1" style="border-top: 1px solid #eee;"></div>			
                <div class="row-fluid span8 offset3" style="margin-bottom:20px;margin-left: 50% !important;">
    
                    <a id="submit" class="btn blue" data-toggle="modal" <?php if($is_ip_exists>0){?> style="pointer-events:none;" <?php }?>>Submit</a>
    ...
    jQuery(document).ready(function() {
		...
		$(document).on('click','input[type="checkbox"],input[type="text"],.btn',function(event){
			...
			{?>
				...
				alert('Έχετε ήδη ψηφήσει για σήμερα, μπορείτε να ψηφίσετε αύριο πάλι !');
				return false;		
			<?php
			}?>			
		});
        ...
        $("#submit").click(function(){
            ...
            if(selected_count == 0){
                ...
                alert("Παρακαλώ επιλέξετε τουλάχιστο ένα τραγούδι!!")
