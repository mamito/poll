...
<div class="page-container row-fluid" style="background:#00aeef;">
    ...
    <div class="page-content backgr" style="min-height:5000px; background-color:#662483">
        <div class="row-fluid span10 offset1 box-shadow--8dp" style="background-color: #fff;margin-bottom:30px;margin-top:20px;">
			...
			<img src="<?php echo base_url();?>media/image/sma-cover-web2.jpg" style="width:100%; max-width:1393px; text-align:center;">
            </div>
...
<?php */ ?>            </div>
            <div class="row-fluid span4 offset4">
				...
				<h3 style="line-height: 25px; text-align:left;width: 100% !important; font-size:1.0em;font-weight: 400 !important;margin-top: -16px;">Ανάδειξε τους αγαπημένους σου καλλιτέχνες μέσα από 12 διαφορετικές κατηγορίες. Δες τις υποψηφιότητες και ψήφισε, μέχρι και πέντε σε κάθε κατηγορία, πιο κάτω τους καλύτερους της χρονιάς.</h3> <p style="font-size:0.8em">(επίσημες κυκλοφορίες 1 Ιανουαρίου 2017 – 31 Δεκεμβρίου 2017).</p>
                ...
                <div class="control-group" id="<?php echo $cate_id; ?>">
                    <h4 class="que_title" style="font-weight: 400 !important;"><?php echo $cate_name; ?></h4>
                    <h4 class="sub_title"><?php echo $que_txt; ?></h4>
...
<h4 style="font-weight: 400 !important;">Young Idol <b>by </b><img src="<?php echo base_url();?>media/image/vw.png"></h4>
<p></p>
<label for="youngidolname">Ψηφίστε το αγαπημένο σας νεανικό είδωλο</label><input type="text" name="youngidolname" id="youngidolname" />
<br class="clear" /> 

<hr>

<h4 style="font-weight: 400 !important;">Δημοφιλέστερος Καλλιτέχνης 20ετίας SUPER FM</h4>
<p>Ψηφίστε τον καλλιτέχνη που θεωρείτε καλύτερο της 20ετίας 1998 – 2018</p>
<label for="famousartistmen">Άντρας:</label><input type="text" name="famousartistmen" id="famousartistmen" />
<br class="clear" /> 
<label for="famousartistwomen">Γυναίκα:</label><input type="text" name="famousartistwomen" id="famousartistwomen" />
<br class="clear" /> 
...
<?php */ ?> <label class="control-label"><?php echo "Τηλέφωνο" ?></label>
  ...
  <?php */ ?>
                ...
                <p style="text-align:center;"><b>(Το τηλέφωνο είναι αναγκαίο για να επικοινωνήσουμε μαζί σου σε περίπτωση που κερδίσεις.)</b></p></br>
    ...
    <div class="row-fluid span8 offset4" style="margin-bottom:20px;/*margin-left: 50% !important;*/text-align: center;">
        ...
        <a id="submit" class="btn blue" data-toggle="modal" <?php if ($is_ip_exists > 0) { ?> style="pointer-events:none;" <?php } ?>>Καταχώρηση</a>

        </br></br><p style="text-align: center;">Η ηλεκτρονική ψηφοφορία ξεκίνησε στις 23 Απριλίου και θα διαρκέσει μέχρι το Σάββατο, 19 Μαΐου 2018.</p>
