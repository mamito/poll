...
<div class="page-container row-fluid" style="background:#00aeef;">
    ...
    <div class="page-content backgr" style="/*min-height:5000px;*/ min-height:2500px; background-color: #e21d45; background-color: -moz-linear-gradient(top, #e21d45 0%, #dd1a4c 100%); background-color: -webkit-linear-gradient(top, #e21d45 0%,#dd1a4c 100%); background-color: linear-gradient(to bottom, #e21d45 0%,#dd1a4c 100%); filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e21d45', endColorstr='#dd1a4c',GradientType=0 ); ">
        <div class="row-fluid span10 offset1 box-shadow--8dp" style="background-color: #fff;margin-bottom:30px;margin-top:20px;">
            ...
            <?php if($is_ip_exists) {?>
            <div id="alertBox" class="row-fluid span7 offset3" style="margin-top:5px;line-height: 30px;font-size:1.3em; background:#e21d45; color:white; text-align:center; font-weight:bold; margin-bottom:30px; border-radius:5px;">
			...
			<img src="<?php echo base_url();?>media/image/top40_2018_1400x400.jpg" style="width:100%; max-width:1393px; text-align:center;">
            </div>
...
<?php */ ?>            </div>
          ...
          <h3 class="text_before_vote"><p>Ετοιμάσαμε την λίστα με τα 40 τραγούδια, ελληνικού και ξένου ρεπερτορίου, με τις περισσότερες μεταδόσεις στον SUPER FM μέσα στο 2018*. Ζητάμε από εσάς, τους ακροατές μας, να μας βοηθήσετε να διαμορφώσουμε τη τελική κατάταξη στο SUPER TOP40 του 2018 και να αναδείξουμε το Νο1, το δημοφιλέστερο τραγούδι της φετινής χρονιάς!</p>

<p>Ψηφίστε τα KAΛΥΤΕΡΑ ΤΡΑΓΟΥΔΙΑ ΤΟΥ 2018 και μπείτε αυτόματα στην κλήρωση για να διεκδικήσετε <a href="http://www.superfmradio.com/n/psifiste-ta-kalytera-tragoydia-toy-2018/" target="_blank" style="text-decoration: underline; color: darkblue;">ένα υπέροχο χριστουγεννιάτικο ταξιδιωτικό πακέτο</a> για δύο άτομα με προορισμό την Μάλτα!</p>

<p style="font-weight: 600 !important;">Διαλέξτε μέχρι 10 από την πιο κάτω λίστα με τα 40 πρώτα σε μεταδόσεις τραγούδια της χρονιάς (αλφαβητικά, ελληνικά–διεθνή):</p>
...
<!--				<img style="margin-bottom:20px;" class="" src="<?php echo base_url();?>media/image/keimeno.png">-->
				...
				<h3 style="line-height: 25px; text-align:left;width: 100% !important; font-size:1.0em;font-weight: 400 !important;margin-top: -16px;">Ετοιμάσαμε την λίστα με τα 40 τραγούδια, ελληνικού και ξένου ρεπερτορίου, με τις περισσότερες μεταδόσεις στον SUPER FM μέσα στο 2018*. Ζητάμε από εσάς, τους ακροατές μας, να μας βοηθήσετε να διαμορφώσουμε τη τελική κατάταξη στο SUPER TOP40 του 2018 και να αναδείξουμε το Νο1, το δημοφιλέστερο τραγούδι της φετινής χρονιάς!</p>
...
<p style="font-weight: 600 !important;">Διαλέξτε μέχρι 10 από την πιο κάτω λίστα με τα 40 πρώτα σε μεταδόσεις τραγούδια της χρονιάς (αλφαβητικά, ελληνικά–διεθνή):</p>
        ...
        <script>
            $("input[name='<?php echo $cate_id;?>']").change(function () {
                ...
                if (cnt > <?php echo $allowed_choices;?>) {
                    ...
                    alert('Μπορείτε να επιλέξετε μέχρι <?php echo $allowed_choices;?> τραγούδια!');
        ...
        ?>
<br>
<p style="font-size:12px;">*Μεταδόσεις από 01/01/2018 έως 18/11/2018.</p>
<br>
    </div>


    <div class="row-fluid span8 offset4">
	<h3 class="text_before_vote">
        <p style="/*text-align:center;width: 97%;*/ color:white; background-color:#e21d45; border-radius:5px; padding:5px; /*margin-right:5px;*/ ">Συμπληρώστε τα στοιχεία σας και διεκδικείστε ένα υπέροχο χριστουγεννιάτικο ταξιδιωτικό πακέτο για δύο άτομα με προορισμό την Μάλτα! Το ταξίδι αφορά τις ημερομηνίες 23 με 26 Δεκεμβρίου και περιλαμβάνει αεροπορικά εισιτήρια και διαμονή σε 4* ξενοδοχείο!</p>
		</h3>
...
<?php */ ?> <label class="control-label"><?php echo "Τηλέφωνο" ?></label>
  ...
  <?php */ ?>
                ...
                <p style="text-align:center;"><b> (Το τηλέφωνο είναι αναγκαίο για να επικοινωνήσουμε μαζί σας σε περίπτωση που κερδίσετε.) </b></p>
    ...
    <div class="row-fluid span8 offset4" style="margin-bottom:20px;/*margin-left: 50% !important;*/text-align: center;">
        ...
        <a id="submit" style="background-color:#e21d45; color:white; font-weight:700;" class="btn blue" data-toggle="modal" <?php if ($is_ip_exists > 0) { ?> style="pointer-events:none;" <?php } ?>>Ψηφίστε τώρα!</a>

        </br></br><p style="text-align: center;">Η ηλεκτρονική ψηφοφορία ξεκίνησε στις 19 Νοεμβρίου και θα διαρκέσει μέχρι τις 14 Δεκεμβρίου 2018.</p>
                    ...
                    ajax_proc("<?php echo base_url();?>voker/save", param,
                        ...
                        function (data) {
                            ...
                            if (rlt == "ok") {
                                ...
                                alert("Σας ευχαριστούμε για τη ψήφο σας!");
